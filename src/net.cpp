...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Eastcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"eastcointools.com", "10.234.210.131"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"eastcointools.com", "testnet-seed.eastcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Eastcoin is probably already running."), addrBind.ToString().c_str());
        else
